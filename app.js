...
function addUserCommentToConversation() {
    $(".Conversation").append("<li class='ui-li ui-li-static ui-body-c'>" + $("#textinput2").val() + "</li>");
    $(".Conversation").scrollTop($(".Conversation").prop("scrollHeight"));
}

function addReplyToConversation(Eliza)
{
    $(".Conversation").append( "<li data-role='list-divider' role='heading' class='ui-li ui-li-divider ui-btn ui-bar-b'>" + Eliza + "</li>" );
    $(".Conversation").scrollTop($(".Conversation").prop("scrollHeight"));
}

function clearUserInputBox() {
    $("#textinput2").val('');
}

function runEliza() {

    dialog($("#textinput2").val());
}
...
// And to give the illusion that some thinking is going on
	...
	function dialog(Input){
		...
		addReplyToConversation(elizaresponse);
	}
	function respond(){
		chatpoint -- ; 
